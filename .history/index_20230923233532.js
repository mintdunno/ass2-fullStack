...
//Get shipper profile
app.get("/shipper/profile/:id", async (req, res) => {
...
app.post("/shipper/profile/:id", async (req, res) => {
  let updateData = {
...
app.get("/shipper/:id/privacy", async (req, res) => {
  const shipper = await Shipper.findById(req.params.id);
...
app.get("/shipper/:id/operating", async (req, res) => {
  const shipper = await Shipper.findById(req.params.id);
...
app.get("/shipper/:id/shipping", async (req, res) => {
  const shipper = await Shipper.findById(req.params.id);
...
app.get("/shipper/:id/return", async (req, res) => {
  const shipper = await Shipper.findById(req.params.id);
