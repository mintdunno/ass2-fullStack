...
shipperRouter.get("/shipper/homepage/:id", async (req, res) => {
...
//Get shipper profile
shipperRouter.get("/shipper/profile/:id", async (req, res) => {
...
shipperRouter.post("/shipper/profile/:id", async (req, res) => {
    let updateData = {
...
shipperRouter.get("/shipper/:id/privacy", async (req, res) => {
    const shipper = await Shipper.findById(req.params.id);
...
shipperRouter.get("/shipper/:id/operating", async (req, res) => {
    const shipper = await Shipper.findById(req.params.id);
...
shipperRouter.get("/shipper/:id/shipping", async (req, res) => {
    const shipper = await Shipper.findById(req.params.id);
...
shipperRouter.get("/shipper/:id/return", async (req, res) => {
    const shipper = await Shipper.findById(req.params.id);
